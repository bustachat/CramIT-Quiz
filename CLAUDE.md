...
│       │                                vet-construction.json is the only one (23/23).
...
│   └── vet-construction.json          ← 75 MC + **72 written**, 2021-2025. ✅ COMPLETE
│                                        and the ONLY fully reviewed subject (2026-09-01):
│                                        written coverage **76/76 official parts** (was
│                                        23/76) and **72/72 reviewed** against NESA —
│                                        55 ok, 6 corrected, 11 divergent-accepted. Every
...
| VET Construction | `vet` | `vet-construction` | MC + written | 75 MC, **72 written**, 2021–2025 — **complete: 76/76 official written parts, 72/72 reviewed** | ✅ `VET_Construction_Quiz_v6 (...).html` |
