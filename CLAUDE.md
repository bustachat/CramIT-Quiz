...
│   ├── mathematics-standard-2.json    ← 318 MC + 151 written + 73 tips + studyNotes (9 of 16 topics so far — F1, F4, M1, M7, A4, A1, A2, F5, M2; no writingScaffolds; queue in progress: M6, N2, N3, S1, S2, S4, S5, then alphabetical reorder — see docs/HISTORY.md)
