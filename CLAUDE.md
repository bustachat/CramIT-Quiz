...
*CLAUDE.md — CramIT Project — Last updated: 2026-07-28 — Study Mode extended to Mathematics Standard 2 (F1 Money Matters pilot topic, §6/§10/§11); earlier: Study Mode/Exam Mode front page added to index.html (HMS prototype); before that: Content Agent rebuilt (triage + generation, PR-only, nightly via content-agent.yml); before that: restructured, session history moved to docs/HISTORY.md.*
