...
│   ├── mathematics-standard-2.json    ← 318 MC + 151 written + 73 tips + studyNotes (2 of 16 topics so far — F1 Money Matters, F4 Investments & Loans; no writingScaffolds, being built topic-by-topic, 14 categories remaining)
...
*CLAUDE.md — CramIT Project — Last updated: 2026-07-28 — Study Mode Maths build: F4 Investments & Loans added (2 of 16 topics, one-at-a-time by owner preference), Notes/Writing Help toggle now hidden when a subject has no writingScaffolds (§6/§10/§11); earlier same day: Study Mode extended to Mathematics Standard 2 (F1 Money Matters pilot topic); earlier (2026-07-27): an automated billing test harness, a "Manage subjects" removal feature, and deferred-downgrade billing (Stripe Subscription Schedules) were built, broke live, rolled back, and were fixed and confirmed working — see `docs/HISTORY.md`; that session also phased the Study Mode rollout (P1 Maths, P2 VET, then Multimedia — superseded now that Maths work has started) and flagged a design aesthetics review as next focus (§11); before that: Study Mode/Exam Mode front page added to index.html (HMS prototype); before that: Content Agent rebuilt (triage + generation, PR-only, nightly via content-agent.yml); before that: restructured, session history moved to docs/HISTORY.md.*
