...
*CLAUDE.md — CramIT Project — Last updated: 2026-07-02 — Code review complete; submit-test crash, model-answer display, PWA icons, and iOS install banner fixed.*
