...
│   ├── mathematics-standard-2.json    ← 318 MC + 151 written + 73 tips + studyNotes (all 16 topics — F1, F4, M1, M7, A4, A1, A2, F5, M2, M6, N2, N3, S1, S2, S4, S5; no writingScaffolds; queue complete — alphabetical reorder pending, then alphabetical reorder — see docs/HISTORY.md)
