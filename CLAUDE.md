...
*CLAUDE.md — CramIT Project — Last updated: 2026-06-09 — HMS FA2 Training questions (58 MC + 10 written), FA1/FA2 assessment toggle, bug fixes: results breakdown in practice mode, written results message, AI marking quota for active subscribers, pill scroller containment on desktop.*
