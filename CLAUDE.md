...
*CLAUDE.md — CramIT Project — Last updated: 2026-06-17 — Stimulus image overhaul complete: 13 SVGs for geometric/network diagrams, 15 tight-crop JPGs for data graphs, 5 table questions with embedded table data (image removed). All 34 full-page placeholder images replaced.*
