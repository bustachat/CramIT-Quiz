...
**UPDATE 2026-09-01 — VET Construction is done, 23/23.** It went first exactly as the two
findings below argued, and both were vindicated: its `bandDescriptors` were missing data rather
than an unreviewed field, and **6 of its 23 written questions carried a real defect**, every one
